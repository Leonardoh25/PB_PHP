...
<html lang="pt-BR">
        ...
        <body>
            ...
            <form action="" method="POST" style="backgroud:#f2f2f2; padding:15px
                ...
                <input type="email" name="email" value="" style="width:100%;
                    margin-bottom:10px"><br>
                Senha: <br>
                <input type="password" name="senha" value="" style="width:100%;
                    margin-bottom:10px"><br>
                <button type="submit" style="background:green;
                    color:white; padding: 5px 10px;">Cadastrar</botton>
